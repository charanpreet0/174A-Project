...
public class CustomerFuncs {
    ...
    public static void insert_Customer(String name, String state, String email_address, String tax_ID_num, String password, String username){
        ...
        try {
            Connection conn = CreateAndInitTable.connect();
            ...
            PrintExtension.info("Registration succeeded, new customer account made...");
    ...
    public static String list_active_users(){    
        ...
        try{
            ...
            Statement stmt = conn.createStatement(); 
            PreparedStatement preparedStatement = stmt.prepareStatement(my_query);
            ResultSet my_resultSet = preparedStatement.executeQuery(); 
            while(my_resultSet.next()){
                String username = my_resultSet.getString("username");
                String tax_ID = my_resultSet.getString("Tax_ID");
